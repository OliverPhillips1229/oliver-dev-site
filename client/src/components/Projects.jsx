    ...
    <section id="projects" style={{padding:'2rem 0'}}>
      ...
      <div className="grid">
        <article className="card">
          <h3>python-data-structures-lab</h3>
          <small style={{color:'var(--gray_600)'}}>Python · Data Structures · Education</small>
          <p>Lab exercises and examples for Python data structures.</p>
          <div style={{display:'flex', gap:'.5rem', flexWrap:'wrap', marginBottom:'.5rem'}}>
            <span style={{fontSize:12, opacity:.8, border:'1px solid rgba(255,255,255,.12)', padding:'.15rem .4rem', borderRadius:6}}>Python</span>
            <span style={{fontSize:12, opacity:.8, border:'1px solid rgba(255,255,255,.12)', padding:'.15rem .4rem', borderRadius:6}}>Data Structures</span>
            <span style={{fontSize:12, opacity:.8, border:'1px solid rgba(255,255,255,.12)', padding:'.15rem .4rem', borderRadius:6}}>Education</span>
          </div>
          <a className="btn" href="https://github.com/OliverPhillips1229/python-data-structures-lab" target="_blank" rel="noopener noreferrer">View Repo</a>
        </article>
        <article className="card">
          <h3>python-control-flow-lab</h3>
          <small style={{color:'var(--gray_600)'}}>Python · Control Flow · Education</small>
          <p>Lab exercises and examples for Python control flow.</p>
          <div style={{display:'flex', gap:'.5rem', flexWrap:'wrap', marginBottom:'.5rem'}}>
            <span style={{fontSize:12, opacity:.8, border:'1px solid rgba(255,255,255,.12)', padding:'.15rem .4rem', borderRadius:6}}>Python</span>
            <span style={{fontSize:12, opacity:.8, border:'1px solid rgba(255,255,255,.12)', padding:'.15rem .4rem', borderRadius:6}}>Control Flow</span>
            <span style={{fontSize:12, opacity:.8, border:'1px solid rgba(255,255,255,.12)', padding:'.15rem .4rem', borderRadius:6}}>Education</span>
          </div>
          <a className="btn" href="https://github.com/OliverPhillips1229/python-control-flow-lab" target="_blank" rel="noopener noreferrer">View Repo</a>
        </article>
        <article className="card">
